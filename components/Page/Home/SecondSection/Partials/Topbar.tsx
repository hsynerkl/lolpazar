...
type TopbarProps = {
  region: number;
  handleRegion: (region: number) => void;
};

const Topbar: FC<TopbarProps> = ({ region, handleRegion }) => {
  return (
    <>
      <p className="text-center text-3xl font-bold">30 Level Smurf Hesaplar</p>
      <p className="text-[#6f7d95] text-center mt-5 mb-10 font-medium">
        Hesaplarımız en yüksek kalitededir ve fiyat bazında garanti
        kapsamındadır.
      </p>
      <div className="flex justify-center gap-3">
        <div
          onClick={() => handleRegion(0)}
          className={`flex gap-2 font-medium text-sm bg-[#242635] group hover:text-[#43b6f9] transition duration-300 cursor-pointer border px-4 py-2 card-shadow rounded-full ${
            region === 0
              ? "!border-[#43B6F9] text-[#43b6f9]"
              : "border-transparent"
          }`}
        >
          <svg
            ...
            fill="#fff"
            className={`h-5 w-5 group-hover:fill-[#43b6f9] transition duration-300 ${
              region === 0 ? "fill-[#43b6f9]" : "fill-white"
            }`}
          >
            <g
        ...
        >
          <svg
            ...
            viewBox="0 0 98.000000 106.000000"
            className={`h-5 w-5 group-hover:fill-[#43b6f9] transition duration-300 ${
              region === 1 ? "fill-[#43b6f9]" : "fill-white"
            }`}
          >
            <g
              transform="translate(0.000000,106.000000) scale(0.100000,-0.100000)"
